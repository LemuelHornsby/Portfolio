...
s3 = boto3.client(
    's3',
    aws_access_key_id="AKIARGLDCV3BEIH5SQSW",           # AWS access key
    aws_secret_access_key="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"  # AWS secret key
)

bucket_name = "swakpalawsbucket"  # S3 bucket name in AWS
